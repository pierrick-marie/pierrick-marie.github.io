...
function setupArrows() {
	...
	$(`.${TITLE}`).after(`
		<nav>
			<img class="${GALLERY}-left-arrow ${ARROWS}" src="./img/left-arrow.png" onclick="leftArrowClicked()"/>
			<img class="${GALLERY}-right-arrow ${ARROWS}" src="./img/right-arrow.png" onclick="rightArrowClicked()"/>
		</nav>
	`);	// Insert the arrows
}
